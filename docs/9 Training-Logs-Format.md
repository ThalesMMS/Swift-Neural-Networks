...
This page documents the CSV log file format used to record per-epoch training metrics generated by the Swift neural network implementations. These logs enable post-training analysis and visualization of model convergence behavior. For information about visualizing these logs, see [Training Visualization](6a%20Training-Visualization.md). For details on the binary model serialization format, see [Model Binary Format](8%20Model-Binary-Format.md).
...
* **Sources**: [Project overview and setup](https://github.com/ThalesMMS/Swift-Neural-Networks/blob/3a1c4fc2/README.md#L167-L176)
...
* **Sources**: [Project overview and setup](https://github.com/ThalesMMS/Swift-Neural-Networks/blob/3a1c4fc2/README.md#L165-L176)  (benchmark data)
...
* [Training Logs Format](9%20Training-Logs-Format.md)
* [Purpose and Scope](9%20Training-Logs-Format.md)
* [File Format Specification](9%20Training-Logs-Format.md)
* [Field Descriptions](9%20Training-Logs-Format.md)
* [Field Semantics](9%20Training-Logs-Format.md)
* [File Naming Conventions](9%20Training-Logs-Format.md)
* [Log Generation Process](9%20Training-Logs-Format.md)
* [Code Flow for Log Writing](9%20Training-Logs-Format.md)
* [Log Consumption by Visualization Tools](9%20Training-Logs-Format.md)
* [Parsing Implementation](9%20Training-Logs-Format.md)
* [Example Log Contents](9%20Training-Logs-Format.md)
* [MLP Training Log (10 epochs)](9%20Training-Logs-Format.md)
* [CNN Training Log (3 epochs)](9%20Training-Logs-Format.md)
* [Data Type Precision](9%20Training-Logs-Format.md)
* [Written Format (Swift)](9%20Training-Logs-Format.md)
* [Parsed Format (Python)](9%20Training-Logs-Format.md)
* [Log File Lifecycle](9%20Training-Logs-Format.md)
* [Common Issues and Limitations](9%20Training-Logs-Format.md)
* [Missing Header Row](9%20Training-Logs-Format.md)
* [No Metadata](9%20Training-Logs-Format.md)
* [Overwrite Behavior](9%20Training-Logs-Format.md)
* [Limited Metrics](9%20Training-Logs-Format.md)
